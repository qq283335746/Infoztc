...
{
    public partial class ActivityPlayerNew
    {
        private static readonly IActivityPlayerNew dal = DataAccess.CreateActivityPlayerNew();

        #region ActivityPlayerNew Member
