...
namespace TygaSoft.BLL
{
    ...
    {
        private static readonly IPlayerPictureNew dal = DataAccess.CreatePlayerPictureNew();

        #region PlayerPictureNew Member
