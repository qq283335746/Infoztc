...
namespace TygaSoft.BLL
{
    ...
    {
        private static readonly ITVProgram dal = DataAccess.CreateTVProgram();

        #region TVProgram Member
        ...
        {
            return dal.GetTable(pageIndex, pageSize, out totalRecords, sqlWhere, cmdParms);
        }
