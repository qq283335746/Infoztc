...
{
    public partial class ActivityPictureNew
    {
        private static readonly IActivityPictureNew dal = DataAccess.CreateActivityPictureNew();

        #region ActivityPictureNew Member
