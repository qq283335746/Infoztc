...
{
    public partial class ListActivitySubject : System.Web.UI.Page
    {
        ...
        private void GetSearchItem()
        {
            ...
            if (!string.IsNullOrWhiteSpace(type))
            {
                ...
                sqlWhere += "and ActivityType = @ActivityType ";
                SqlParameter parm = new SqlParameter("@ActivityType", SqlDbType.Int);
                parm.Value = int.Parse(type);
                parms.Add(parm);
            }
        }
