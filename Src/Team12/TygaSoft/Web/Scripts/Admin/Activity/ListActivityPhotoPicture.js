    ...
    Add: function () {
        ...
        $("#dlgUpload").dialog({
            ...
            buttons: [{
                ...
                iconCls: 'icon-ok',
                handler: function () {
                    ListActivityPhotoPicture.OnUpload();
                }
            }, {
                text: '取 消',
                iconCls: 'icon-cancel',
        ...
        try {
            ...
            $('#dlgUploadFm').form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    param.reqName = "ActivityPhotoPicture";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelActivityPhotoPicture",
                        type: "post",
