...
var ListPictureAdStartup = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureAdStartup";
        DlgPictureSelect.CallBack = "ListPictureAdStartup.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureAdStartup",
                        type: "post",
