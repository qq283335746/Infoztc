...
namespace TygaSoft.Web.ScriptServices
{
    ...
    public class AdminService : System.Web.Services.WebService
    {
        ...
        public string DelContentType(string id)
        {
            ...
            try
            {
                ...
                using (TransactionScope scope = new TransactionScope())
                {
                    ...
                    if (oldModel != null)
                    {
                        bll.UpdateHasChild(oldModel.ParentId);
                    }
        ...
        [WebMethod]
        public string DelAdvertisementPicture(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
                    ...
                    using (TransactionScope scope = new TransactionScope())
                    {
                        foreach (var model in list)
                        {
                            ...
                            if (Directory.Exists(dir))
                            {
                                ...
                                Task.Factory.StartNew(() => Directory.Delete(dir, true));
                            }
                            string sourceFile = Server.MapPath("~" + string.Format("{0}{1}", model.FileDirectory, model.FileName));
        ...
        [WebMethod]
        public string DelAdBase(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
                ...
                AdItem adiBll = new AdItem();
                int effect = 0;

                foreach(var item in list)
                {
                    var adItemList = adiBll.GetList("and AdvertisementId = @AdId", new SqlParameter("@AdId", item));
                    if(adItemList != null && adItemList.Count > 0)
                    {
                        IList<object> adiIdList = new List<object>();
                        foreach(var adiModel in adItemList)
                        {
                            adiIdList.Add(adiModel.Id);
                        }
                        if (adiBll.DeleteBatchByJoin(adiIdList)) effect++;
                    }
                }
        ...
        [WebMethod]
        public string DelAdItem(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        public string GetJsonForCategory()
        {
            ...
            {
                new CustomException(string.Format("方法：AdminService.GetJsonForCategory()异常：{0}", ex.Message), ex);
                return "[]";
            }
        }
        ...
        public string GetJsonForBrand()
        {
            ...
            {
                new CustomException(string.Format("方法：AdminService.GetJsonForBrand()异常：{0}", ex.Message), ex);
                return "[]";
            }
        }
        ...
        public string SaveBrand(BrandInfo model)
        {
            ...
            {
                new CustomException("方法：AdminService.SaveBrand(BrandInfo model)异常：" + ex.Message + "", ex);
                errorMsg = ex.Message;
            }
        ...
        [WebMethod]
        public string DelPictureBrand(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureCategory(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureProduct(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureProductSize(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        public string DelProduct(string itemAppend)
        {
            ...
            try
            {
                ...
                ProductDetail pdBll = new ProductDetail();
                ProductItem piBll = new ProductItem();

                using (TransactionScope scope = new TransactionScope())
                {
                    bll.DeleteBatch(itemList);
                    pdBll.DeleteBatch(itemList);
                    piBll.DeleteBatchByProductId(itemList);
        ...
        [WebMethod]
        public string DelProductItem(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelProductAttr(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelProductDetail(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
                ...
                bll.DeleteBatchByProduct(items.ToList<object>());
        ...
        [WebMethod]
        public string DelProductSizePicture(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelProductSize(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelProductImage(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelProductStock(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureServiceItem(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureServiceVote(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureServiceLink(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string DelPictureServiceContent(string itemAppend)
        {
            string errorMsg = string.Empty;
            try
            {
