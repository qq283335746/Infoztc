    ...
    public partial class DlgUploadPicture : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (!string.IsNullOrWhiteSpace(Request.QueryString["dlgParentHref"]))
                {
                    dlgParentHref = Request.QueryString["dlgParentHref"].Trim();
                }
                ...
                myDataAppend.Replace("{DlgParentHref}", "/a/tyy.html?dlgId=" + dlgParentId + "&funName=" + funName + "&isMutil=" + isMutilSelect + "");
