<%@ Page Title="广告其它信息列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListAdOther.aspx.cs" Inherits="TygaSoft.Web.Admin.AboutSite.ListAdOther" %>
...
<div id="advertisementTab" class="easyui-tabs" data-options="fit:true,onSelect:AddAdvertisement.OnTabSelect">
	...
	<div title="其它信息" data-options="selected:true" style="padding:10px">
        <div id="toolbar" style="padding:5px;">
            ...
            <a class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="ListAdOther.Search()">查 詢</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="ListAdOther.Add()">新 增</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListAdOther.Edit()">编 辑</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="ListAdOther.Del()">删 除</a>
        </div>
            ...
            <asp:Repeater ID="rpData" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0)" code='<%#Eval("Id")%>' onclick='ListAdOther.ShowAdItemLink(this)'>查看</a>
                        </td>
                        <td>
                            <a href="javascript:void(0)" code='<%#Eval("Id")%>' onclick='ListAdOther.ShowAdItemContent(this)'>查看</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
...
<div id="dlgAddAdOther" style="padding:10px;"></div>
...
<script type="text/javascript" src="../../Scripts/Admin/AboutSite/ListAdOther.js"></script>
...
<script type="text/javascript">
    ...
    $(function () {
        try {
            var myData = ListAdOther.GetMyData("myDataForPage");
