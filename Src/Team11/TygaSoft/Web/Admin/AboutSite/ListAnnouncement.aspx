...
<table id="dgT" class="easyui-datagrid" title="公告列表" data-options="rownumbers:true,pagination:true,fit:true,fitColumns:true,toolbar:'#toolbar'">
    <thead>
        <tr>
            ...
            <th data-options="field:'f3',width:100">访问量设置</th>
            <th data-options="field:'f4',width:100">实际访问量</th>
...
<script type="text/javascript" src="../../Scripts/Admin/ListAnnouncement.js"></script>
