...
var ListPictureBrand = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureBrand";
        DlgPictureSelect.CallBack = "ListPictureBrand.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureBrand",
                        type: "post",
