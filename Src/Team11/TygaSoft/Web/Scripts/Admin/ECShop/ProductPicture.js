    ...
    PictureMultiClick: function () {
        $("#productPictureBox").children().bind("click", function () {
            ...
            $("#imgProductOther").find("input[type=hidden]").each(function () {
                if ($(this).val() == curr.find("input[type=hidden]").val()) {
                    hasExist = true;
                    return false;
                }
            })
            ...
            newCol.find("img").attr("src", curr.find("img").attr("src"));
            newCol.find("input[type=hidden]").val(curr.find("input[type=hidden]").val());
            newCol.show();
        })
    },
