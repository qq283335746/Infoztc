...
var ListPictureCategory = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureCategory";
        DlgPictureSelect.CallBack = "ListPictureCategory.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureCategory",
                        type: "post",
