...
var ListPictureProductSize = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureProductSize";
        DlgPictureSelect.CallBack = "ListPictureProductSize.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureProductSize",
                        type: "post",
