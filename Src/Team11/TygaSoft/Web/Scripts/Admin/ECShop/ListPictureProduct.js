...
var ListPictureProduct = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureProduct";
        DlgPictureSelect.CallBack = "ListPictureProduct.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureProduct",
                        type: "post",
