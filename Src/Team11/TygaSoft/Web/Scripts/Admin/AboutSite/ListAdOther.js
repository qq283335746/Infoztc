    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "/ScriptServices/AdminService.asmx/DelSupplier",
                        type: "post",
    ...
    SaveAdItem: function () {
        try {
            ...
            if ($.trim($("#hAdItemId").val()) != "") {
                var myOldData = ListAdOther.GetMyData("myOldData");
                var isSameAll = true;
