...
<table id="dgT" class="easyui-datagrid" title="商品列表" data-options="rownumbers:true,pagination:true,fit:true,fitColumns:true,toolbar:'#toolbar'">
    <thead>
        <tr>
            ...
            <th data-options="field:'f2'">名称</th>
            <th data-options="field:'f3'">副标题</th>
            <th data-options="field:'f4'">原价</th>
            <th data-options="field:'f5'">现价</th>
            <th data-options="field:'f6'">折扣率</th>
            <th data-options="field:'f7'">库存</th>
            <th data-options="field:'f8'">浏览次数</th>
    ...
    <asp:Repeater ID="rpData" runat="server">
        <ItemTemplate>
            <tr>
                <td><%#Eval("Id")%></td>
                <td><img src='../..<%#Eval("ImageUrl")%>' alt="" /> </td>
