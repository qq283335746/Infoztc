    ...
    public partial class ListAdvertisement : System.Web.UI.Page
    {
        ...
        private void GetSearchItem()
        {
            if (!string.IsNullOrEmpty(keyword))
            {
                ...
                sqlWhere += "and (ad.Title like @Title or ad.ContentText like @ContentText or ad.Url like @Url) ";
                SqlParameter parm = new SqlParameter("@Title", SqlDbType.NVarChar, 50);
                parm.Value = "%" + keyword + "%";
                parms.Add(parm);
                parm = new SqlParameter("@ContentText", SqlDbType.NVarChar, 1000);
                parm.Value = "%" + keyword + "%";
                parms.Add(parm);
                parm = new SqlParameter("@Url", SqlDbType.NVarChar, 50);
                parm.Value = "%" + keyword + "%";
                parms.Add(parm);
