...
<div class="easyui-panel" style="padding:10px;">
    ...
    <div id="picBox" class="row mt10">
        ...
        <div class="fl mr10">
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="ContentPicture.DlgMulti()">选 择</a>
        </div>
        <div class="fl" style="width:800px;">
...
<div id="dlgContentPicture" title="选择图片" class="easyui-dialog" data-options="closed:true,modal:true,width:$(window).width() * 0.9,height:$(window).height() * 0.9,href:'../../Templates/DlgContentPicture.htm',
    buttons: [{
	    id:'btnSelectContentPicture',text:'确定',iconCls:'icon-ok',handler:function(){
            $('#dlgContentPicture').dialog('close');
	    }
    },{
        id:'btnCancelDlgContentPicture',text:'取消',iconCls:'icon-cancel',handler:function(){
		    $('#dlgContentPicture').dialog('close');
	    }
    }],
    toolbar: [{
        id:'btnDlgContentPicture',text: '上 传',iconCls: 'icon-add',handler: function () {
            ContentPicture.DlgUpload();
        }
    }]
    " style="padding:10px">
...
<script type="text/javascript" src="../../Scripts/Admin/ContentPicture.js"></script>
