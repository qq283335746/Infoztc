...
{
    public partial class PictureBrand : IPictureBrand
    {
        #region IPictureBrand Member

        public int Insert(PictureBrandInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_Brand (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
        ...
        public int Update(PictureBrandInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_Brand set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_Brand where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_Brand where Id = @Id" + n + " ;");
        ...
        public PictureBrandInfo GetModel(object Id)
        {
            PictureBrandInfo model = null;
        ...
        public IList<PictureBrandInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_Brand ");
            ...
            if (totalRecords == 0) return new List<PictureBrandInfo>();
            ...
            IList<PictureBrandInfo> list = new List<PictureBrandInfo>();
        ...
        public IList<PictureBrandInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<PictureBrandInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<PictureBrandInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_Brand
