...
{
    public partial class PictureProductSize : IPictureProductSize
    {
        #region IPictureProductSize Member

        public int Insert(PictureProductSizeInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_ProductSize (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(PictureProductSizeInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_ProductSize set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_ProductSize where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_ProductSize where Id = @Id" + n + " ;");
        ...
        public PictureProductSizeInfo GetModel(object Id)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.HnztcShopDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new PictureProductSizeInfo();
        ...
        public IList<PictureProductSizeInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_ProductSize ");
            ...
            if (totalRecords == 0) return new List<PictureProductSizeInfo>();
            ...
            IList<PictureProductSizeInfo> list = new List<PictureProductSizeInfo>();
        ...
        public IList<PictureProductSizeInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<PictureProductSizeInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<PictureProductSizeInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_ProductSize
