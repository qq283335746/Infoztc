...
{
    public partial class ProductPicture : IProductPicture
    {
        #region IProductPicture Member

        public int Insert(ProductPictureInfo model)
        {
            string cmdText = @"insert into ProductPicture (OriginalPicture,BPicture,MPicture,SPicture,OtherPicture,LastUpdatedDate)
			                 values
        ...
        public int Update(ProductPictureInfo model)
        {
            string cmdText = @"update ProductPicture set OriginalPicture = @OriginalPicture,BPicture = @BPicture,MPicture = @MPicture,SPicture = @SPicture,OtherPicture = @OtherPicture,LastUpdatedDate = @LastUpdatedDate 
			                 where Id = @Id";
        ...
        {
            string cmdText = "delete from ProductPicture where Id = @Id";
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from ProductPicture where Id = @Id" + n + " ;");
        ...
        public ProductPictureInfo GetModel(object Id)
        {
            ProductPictureInfo model = null;
        ...
        public List<ProductPictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            string cmdText = @"select count(*) from ProductPicture ";
            ...
            List<ProductPictureInfo> list = new List<ProductPictureInfo>();
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.HnztcShopDbConnString, CommandType.Text, cmdText, cmdParms))
            {
                if (reader != null && reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ProductPictureInfo model = new ProductPictureInfo();
        ...
        public List<ProductPictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public List<ProductPictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
        ...
        public List<ProductPictureInfo> GetList()
        {
            string cmdText = @"select Id,OriginalPicture,BPicture,MPicture,SPicture,OtherPicture,LastUpdatedDate 
			                from ProductPicture
