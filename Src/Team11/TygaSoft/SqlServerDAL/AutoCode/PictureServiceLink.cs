...
{
    public partial class PictureServiceLink : IPictureServiceLink
    {
        #region IPictureServiceLink Member

        public int Insert(PictureServiceLinkInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_ServiceLink (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
parms[5].Value = model.LastUpdatedDate;
        ...
        public int Update(PictureServiceLinkInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_ServiceLink set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[6].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_ServiceLink where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_ServiceLink where Id = @Id" + n + " ;");
        ...
        public PictureServiceLinkInfo GetModel(object Id)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new PictureServiceLinkInfo();
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceLinkInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_ServiceLink ");
			...
			if (totalRecords == 0) return new List<PictureServiceLinkInfo>();
            ...
            IList<PictureServiceLinkInfo> list = new List<PictureServiceLinkInfo>();
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceLinkInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceLinkInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceLinkInfo> GetList()
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_ServiceLink
