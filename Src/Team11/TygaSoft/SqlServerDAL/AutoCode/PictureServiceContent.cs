...
{
    public partial class PictureServiceContent : IPictureServiceContent
    {
        #region IPictureServiceContent Member

        public int Insert(PictureServiceContentInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_ServiceContent (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
parms[5].Value = model.LastUpdatedDate;
        ...
        public int Update(PictureServiceContentInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_ServiceContent set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[6].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_ServiceContent where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_ServiceContent where Id = @Id" + n + " ;");
        ...
        public PictureServiceContentInfo GetModel(object Id)
        {
            PictureServiceContentInfo model = null;

			StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			                   from Picture_ServiceContent
							   where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new PictureServiceContentInfo();
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceContentInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_ServiceContent ");
			...
			if (totalRecords == 0) return new List<PictureServiceContentInfo>();
            ...
            IList<PictureServiceContentInfo> list = new List<PictureServiceContentInfo>();
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceContentInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceContentInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceContentInfo> GetList()
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_ServiceContent
