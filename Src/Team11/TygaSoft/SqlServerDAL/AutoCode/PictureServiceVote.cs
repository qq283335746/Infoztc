...
{
    public partial class PictureServiceVote : IPictureServiceVote
    {
        #region IPictureServiceVote Member

        public int Insert(PictureServiceVoteInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_ServiceVote (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
parms[5].Value = model.LastUpdatedDate;
        ...
        public int Update(PictureServiceVoteInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_ServiceVote set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[6].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_ServiceVote where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_ServiceVote where Id = @Id" + n + " ;");
        ...
        public PictureServiceVoteInfo GetModel(object Id)
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new PictureServiceVoteInfo();
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceVoteInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_ServiceVote ");
			...
			if (totalRecords == 0) return new List<PictureServiceVoteInfo>();
            ...
            IList<PictureServiceVoteInfo> list = new List<PictureServiceVoteInfo>();
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceVoteInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureServiceVoteInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
...
model.LastUpdatedDate = reader.GetDateTime(6);
        ...
        public IList<PictureServiceVoteInfo> GetList()
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_ServiceVote
