...
namespace TygaSoft.DBUtility
{
    public sealed class SqlHelper
    {
        ...
        public static readonly string HnztcTeamDbConnString = ConfigurationManager.ConnectionStrings["TeamDbConnString"].ConnectionString;
        public static readonly string HnztcShopDbConnString = ConfigurationManager.ConnectionStrings["ShopDbConnString"].ConnectionString;
        public static readonly string HnztcOrdersDbConnString = ConfigurationManager.ConnectionStrings["OrdersDbConnString"].ConnectionString;
        public static readonly string HnztcSystemDbConnString = ConfigurationManager.ConnectionStrings["SystemDbConnString"].ConnectionString;
        public static readonly string TygaAspnetDbConnString = ConfigurationManager.ConnectionStrings["AspnetDbConnString"].ConnectionString;
