...
{
    public partial class PictureInformation : IPictureInformation
    {
        #region IPictureInformation Member

        public int Insert(PictureInformationInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Picture_Information (UserId,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
parms[6].Value = model.LastUpdatedDate;
        ...
        public int Update(PictureInformationInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Picture_Information set UserId = @UserId,FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[7].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Picture_Information where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Picture_Information where Id = @Id" + n + " ;");
        ...
        public PictureInformationInfo GetModel(object Id)
        {
            PictureInformationInfo model = null;
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.HnztcTeamDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    if (reader.Read())
                    {
                        model = new PictureInformationInfo();
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureInformationInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Picture_Information ");
			...
			if (totalRecords == 0) return new List<PictureInformationInfo>();
            ...
            IList<PictureInformationInfo> list = new List<PictureInformationInfo>();
...
model.LastUpdatedDate = reader.GetDateTime(8);
        ...
        public IList<PictureInformationInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
...
model.LastUpdatedDate = reader.GetDateTime(8);
        ...
        public IList<PictureInformationInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
...
model.LastUpdatedDate = reader.GetDateTime(7);
        ...
        public IList<PictureInformationInfo> GetList()
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,UserId,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from Picture_Information
