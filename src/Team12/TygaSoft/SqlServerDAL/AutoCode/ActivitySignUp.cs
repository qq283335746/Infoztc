...
parms[3].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update ActivitySignUp set ActivityId = @ActivityId,UserId = @UserId,Remark = @Remark,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[4].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from ActivitySignUp where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from ActivitySignUp where Id = @Id" + n + " ;");
...
model.LastUpdatedDate = reader.GetDateTime(4);
        ...
        public IList<ActivitySignUpInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
			...
			if (totalRecords == 0) return new List<ActivitySignUpInfo>();
...
model.LastUpdatedDate = reader.GetDateTime(5);
        ...
        public IList<ActivitySignUpInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
