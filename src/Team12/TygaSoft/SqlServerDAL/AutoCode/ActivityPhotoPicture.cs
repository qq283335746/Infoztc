...
{
    public partial class ActivityPhotoPicture : IActivityPhotoPicture
    {
        #region IActivityPhotoPicture Member

        public int Insert(ActivityPhotoPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into ActivityPhotoPicture (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(ActivityPhotoPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update ActivityPhotoPicture set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from ActivityPhotoPicture where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from ActivityPhotoPicture where Id = @Id" + n + " ;");
        ...
        public ActivityPhotoPictureInfo GetModel(object Id)
        {
            ActivityPhotoPictureInfo model = null;

            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			                   from ActivityPhotoPicture
							   where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.HnztcTeamDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new ActivityPhotoPictureInfo();
        ...
        public IList<ActivityPhotoPictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from ActivityPhotoPicture ");
            ...
            if (totalRecords == 0) return new List<ActivityPhotoPictureInfo>();
            ...
            IList<ActivityPhotoPictureInfo> list = new List<ActivityPhotoPictureInfo>();
        ...
        public IList<ActivityPhotoPictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<ActivityPhotoPictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<ActivityPhotoPictureInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from ActivityPhotoPicture
