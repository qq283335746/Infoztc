...
{
    public partial class UserHeadPicture : IUserHeadPicture
    {
        #region IUserHeadPicture Member

        public int Insert(UserHeadPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into UserHeadPicture (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(UserHeadPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update UserHeadPicture set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from UserHeadPicture where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from UserHeadPicture where Id = @Id" + n + " ;");
        ...
        public UserHeadPictureInfo GetModel(object Id)
        {
        ...
        public IList<UserHeadPictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from UserHeadPicture ");
            ...
            if (totalRecords == 0) return new List<UserHeadPictureInfo>();
            ...
            IList<UserHeadPictureInfo> list = new List<UserHeadPictureInfo>();
        ...
        public IList<UserHeadPictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<UserHeadPictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<UserHeadPictureInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from UserHeadPicture
