...
{
    public partial class AdvertPicture
    {
        private static readonly IAdvertPicture dal = DataAccess.CreateAdvertPicture();

        #region AdvertPicture Member
