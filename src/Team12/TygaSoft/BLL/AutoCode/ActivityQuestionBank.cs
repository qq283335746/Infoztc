...
namespace TygaSoft.BLL
{
    ...
    {
        private static readonly IActivityQuestionBank dal = DataAccess.CreateActivityQuestionBank();

        #region ActivityQuestionBank Member
        ...
        {
            return dal.Delete(activityReleaseId);
        }
        ...
        {
            return dal.GetModel(activityReleaseId);
        }
