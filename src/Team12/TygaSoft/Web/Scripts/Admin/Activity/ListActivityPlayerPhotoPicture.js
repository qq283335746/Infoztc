...
var ListActivityPlayerPhotoPicture = {
    Init: function () {
    ...
    Add: function () {
        ...
        $("#dlgUpload").dialog({
            ...
            buttons: [{
                ...
                iconCls: 'icon-ok',
                handler: function () {
                    ListActivityPlayerPhotoPicture.OnUpload();
                }
            }, {
                text: '取 消',
                iconCls: 'icon-cancel',
        ...
        try {
            ...
            $('#dlgUploadFm').form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    param.reqName = "ActivityPlayerPhotoPicture";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelActivityPlayerPhotoPicture",
                        type: "post",
