...
namespace TygaSoft.BLL
{
    ...
    {
        #region ServiceVote Member

        public IList<ServiceVoteInfo> GetListByServiceItemId(int pageIndex, int pageSize, out int totalRecords, Guid serviceItemId)
        {
            string sqlWhere = " and sv.ServiceItemId = @ServiceItemId ";
