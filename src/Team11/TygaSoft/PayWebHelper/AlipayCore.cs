...
namespace TygaSoft.PayWebHelper
{
    ...
    public class Core
    {
        ...
        public static Dictionary<string, string> FilterPara(SortedDictionary<string, string> dicArrayPre)
        {
            ...
            foreach (KeyValuePair<string, string> kvp in dicArrayPre)
            {
                if (kvp.Key.ToLower() != "sign" && kvp.Key.ToLower() != "sign_type" && !string.IsNullOrWhiteSpace(kvp.Value))
                {
                    dicArray.Add(kvp.Key, kvp.Value);
                }
            }
