...
{
    public partial class ServiceUserPraise : IServiceUserPraise
    {
        #region IServiceUserPraise Member

        public int Insert(ServiceUserPraiseInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into Service_UserPraise (UserId,ServiceItemId,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(ServiceUserPraiseInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Service_UserPraise set UserId = @UserId,ServiceItemId = @ServiceItemId,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            string cmdText = "delete from Service_UserPraise where Id = @Id";
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Service_UserPraise where Id = @Id" + n + " ;");
        ...
        public ServiceUserPraiseInfo GetModel(object Id)
        {
            ServiceUserPraiseInfo model = null;

            string cmdText = @"select top 1 Id,UserId,ServiceItemId,LastUpdatedDate 
			                   from Service_UserPraise
							   where Id = @Id ";
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, cmdText, parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new ServiceUserPraiseInfo();
        ...
        public IList<ServiceUserPraiseInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from Service_UserPraise ");
            ...
            if (totalRecords == 0) return new List<ServiceUserPraiseInfo>();
            ...
            IList<ServiceUserPraiseInfo> list = new List<ServiceUserPraiseInfo>();
        ...
        public IList<ServiceUserPraiseInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<ServiceUserPraiseInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<ServiceUserPraiseInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,UserId,ServiceItemId,LastUpdatedDate 
			            from Service_UserPraise
