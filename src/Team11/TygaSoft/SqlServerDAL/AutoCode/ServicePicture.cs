...
{
    public partial class ServicePicture : IServicePicture
    {
        #region IServicePicture Member

        public int Insert(ServicePictureInfo model)
        {
            string cmdText = @"insert into Service_Picture (OriginalPicture,BPicture,MPicture,SPicture,OtherPicture,LastUpdatedDate)
			                 values
        ...
        public int Update(ServicePictureInfo model)
        {
            string cmdText = @"update Service_Picture set OriginalPicture = @OriginalPicture,BPicture = @BPicture,MPicture = @MPicture,SPicture = @SPicture,OtherPicture = @OtherPicture,LastUpdatedDate = @LastUpdatedDate 
			                 where Id = @Id";
        ...
        {
            string cmdText = "delete from Service_Picture where Id = @Id";
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Service_Picture where Id = @Id" + n + " ;");
        ...
        public ServicePictureInfo GetModel(object Id)
        {
            ServicePictureInfo model = null;
        ...
        public IList<ServicePictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            string cmdText = @"select count(*) from Service_Picture ";
            ...
            IList<ServicePictureInfo> list = new List<ServicePictureInfo>();
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, cmdText, cmdParms))
            {
                if (reader != null && reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ServicePictureInfo model = new ServicePictureInfo();
        ...
        public IList<ServicePictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<ServicePictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
        ...
        public IList<ServicePictureInfo> GetList()
        {
            string cmdText = @"select Id,OriginalPicture,BPicture,MPicture,SPicture,OtherPicture,LastUpdatedDate 
			                from Service_Picture
