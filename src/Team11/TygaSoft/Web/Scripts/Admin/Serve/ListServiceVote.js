...
var ListServiceVote = {
    LoadDg: function (id, serviceItemId) {
        var dgVote = $('#' + id + '');
        dgVote.datagrid('options').url = "/h/y.html";
        dgVote.datagrid('load', {
        ...
        try {
            ...
            $('#dlgFmServiceVote').form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    param.isDisable = $("#dlgFmServiceVote").find("input[name=rbtnList_ServiceVote]:checked").val();
                    if ($.trim($("#hServiceVoteId").val()) != "") $("#txtaContent_ServiceVote").val("");
    ...
    OnPictureClick: function () {
        DlgPictureSelect.DlgOpenId = "dlgSingleSelectServiceVotePicture";
        DlgPictureSelect.DlgSingle('PictureServiceVote');
    },
    SetSinglePicture: function (imgEleId) {
        var data = dlgSingleSelectServiceVotePicture.GetPicSelect();
        if (data.length > 0) {
