...
var ListPictureServiceVote = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureServiceVote";
        DlgPictureSelect.CallBack = "ListPictureServiceVote.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureServiceVote",
                        type: "post",
