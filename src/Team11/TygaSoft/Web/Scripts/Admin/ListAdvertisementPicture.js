...
var ListAdvertisementPicture = {
    ...
    Add: function () {
        ...
        $("#dlgUpload").dialog({
            ...
            height: h,
            closed: false,
            href: '/t/gpicture.html',
            modal: true,
            buttons: [{
                text: '上 传',
                iconCls: 'icon-ok',
                handler: function () {
                    ListAdvertisementPicture.OnUpload();
                }
            }, {
                text: '取 消',
                iconCls: 'icon-cancel',
        ...
        try {
            ...
            $('#dlgUploadFm').form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    param.reqName = "AdvertisementPicture";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelAdvertisementPicture",
                        type: "post",
