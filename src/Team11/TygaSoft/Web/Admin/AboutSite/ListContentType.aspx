...
href:'/Templates/AddContentType.htm',buttons: [{
...
<script type="text/javascript" src="../../Scripts/Admin/ListContentType.js"></script>
<script type="text/javascript">
    $(function () {
        try {
            $("#dlg").dialog('refresh', '/Templates/AddContentType.htm');
