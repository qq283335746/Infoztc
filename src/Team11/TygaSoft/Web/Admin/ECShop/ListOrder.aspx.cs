    ...
    public partial class ListOrder : System.Web.UI.Page
    {
        ...
        private void GetSearchItem()
        {
            if (!string.IsNullOrWhiteSpace(name))
            {
                ...
                sqlWhere += "and (o.OrderNum = @OrderNum or o.Receiver like @Receiver or o.ProviceCity like @ProviceCity or o.Address like @Address or o.Mobilephone = @Mobilephone or o.Telephone = @Telephone) ";
                SqlParameter parm = new SqlParameter("@OrderNum", SqlDbType.Char, 12);
                parm.Value = "%" + name + "%";
                parms.Add(parm);
                parm = new SqlParameter("@Receiver", SqlDbType.NVarChar, 30);
                parm.Value = "%" + name + "%";
                parms.Add(parm);
