...
var ListPictureScratchLotto = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureScratchLotto";
        DlgPictureSelect.CallBack = "ListPictureScratchLotto.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureScratchLotto",
                        type: "post",
