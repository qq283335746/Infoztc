...
{
    public partial class TopicComment : ITopicComment
    {
        #region ITopicComment Member

        public int Insert(TopicCommentInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into TopicComment (TopicSubjectId,UserId,ContentText,IsTop,Sort,Remark,IsDisable,LastUpdatedDate)
			            values
						(@TopicSubjectId,@UserId,@ContentText,@IsTop,@Sort,@Remark,@IsDisable,@LastUpdatedDate)
			            ");
...
parms[7].Value = model.LastUpdatedDate;
        ...
        public int Update(TopicCommentInfo model)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update TopicComment set TopicSubjectId = @TopicSubjectId,UserId = @UserId,ContentText = @ContentText,IsTop = @IsTop,Sort = @Sort,Remark = @Remark,IsDisable = @IsDisable,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
parms[1].Value = model.TopicSubjectId;
...
parms[8].Value = model.LastUpdatedDate;
        ...
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from TopicComment where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from TopicComment where Id = @Id" + n + " ;");
        ...
        public TopicCommentInfo GetModel(object Id)
        {
            TopicCommentInfo model = null;

			StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,TopicSubjectId,UserId,ContentText,IsTop,Sort,Remark,IsDisable,LastUpdatedDate 
			                   from TopicComment
							   where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
...
model.LastUpdatedDate = reader.GetDateTime(8);
        ...
        public IList<TopicCommentInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
			...
			if (totalRecords == 0) return new List<TopicCommentInfo>();
            ...
            sb.Append(@"select * from(select row_number() over(order by LastUpdatedDate desc) as RowNumber,
			          Id,TopicSubjectId,UserId,ContentText,IsTop,Sort,Remark,IsDisable,LastUpdatedDate
					  from TopicComment ");
            if (!string.IsNullOrEmpty(sqlWhere)) sb.AppendFormat(" where 1=1 {0} ", sqlWhere);
			sb.AppendFormat(@")as objTable where RowNumber between {0} and {1} ", startIndex, endIndex);

            IList<TopicCommentInfo> list = new List<TopicCommentInfo>();
...
model.TopicSubjectId = reader.GetGuid(2);
...
model.LastUpdatedDate = reader.GetDateTime(9);
        ...
        public IList<TopicCommentInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
...
model.LastUpdatedDate = reader.GetDateTime(9);
        ...
        public IList<TopicCommentInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,TopicSubjectId,UserId,ContentText,IsTop,Sort,Remark,IsDisable,LastUpdatedDate
                        from TopicComment ");
            if (!string.IsNullOrEmpty(sqlWhere)) sb.AppendFormat(" where 1=1 {0} ", sqlWhere);
...
model.LastUpdatedDate = reader.GetDateTime(8);
        ...
        public IList<TopicCommentInfo> GetList()
        {
		    StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,TopicSubjectId,UserId,ContentText,IsTop,Sort,Remark,IsDisable,LastUpdatedDate 
			            from TopicComment
