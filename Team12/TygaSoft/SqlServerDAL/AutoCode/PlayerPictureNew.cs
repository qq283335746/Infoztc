...
namespace TygaSoft.SqlServerDAL
{
    public partial class PlayerPictureNew : IPlayerPictureNew
    {
        ...
        public int Insert(PlayerPictureNewInfo model)
        {
            ...
            sb.Append(@"insert into PlayerPictureNew (PlayerId,PictureId,Sort,IsHeadImg)
			            values
...
new SqlParameter("@IsHeadImg",SqlDbType.Bit)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from PlayerPictureNew where PlayerId = @PlayerId");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from PlayerPictureNew where PlayerId = @PlayerId" + n + " ;");
        ...
        public IList<PlayerPictureNewInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            ...
            if (totalRecords == 0) return new List<PlayerPictureNewInfo>();
        ...
        public IList<PlayerPictureNewInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
