...
{
    public partial class ActivityPlayerPhotoPicture : IActivityPlayerPhotoPicture
    {
        #region IActivityPlayerPhotoPicture Member

        public int Insert(ActivityPlayerPhotoPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into ActivityPlayerPhotoPicture (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(ActivityPlayerPhotoPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update ActivityPlayerPhotoPicture set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from ActivityPlayerPhotoPicture where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from ActivityPlayerPhotoPicture where Id = @Id" + n + " ;");
        ...
        public ActivityPlayerPhotoPictureInfo GetModel(object Id)
        {
            ActivityPlayerPhotoPictureInfo model = null;

            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			                   from ActivityPlayerPhotoPicture
							   where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.HnztcTeamDbConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new ActivityPlayerPhotoPictureInfo();
        ...
        public IList<ActivityPlayerPhotoPictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from ActivityPlayerPhotoPicture ");
            ...
            if (totalRecords == 0) return new List<ActivityPlayerPhotoPictureInfo>();
            ...
            IList<ActivityPlayerPhotoPictureInfo> list = new List<ActivityPlayerPhotoPictureInfo>();
        ...
        public IList<ActivityPlayerPhotoPictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<ActivityPlayerPhotoPictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<ActivityPlayerPhotoPictureInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from ActivityPlayerPhotoPicture
