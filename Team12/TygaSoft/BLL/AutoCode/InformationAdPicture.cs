...
namespace TygaSoft.BLL
{
    ...
    {
        private static readonly IInformationAdPicture dal = DataAccess.CreateInformationAdPicture();
        ...
        {
            return dal.Delete(informationAdId);
        }
        ...
        {
            return dal.GetModel(informationAdId);
        }
