...
{
    public partial class TopicPicture
    {
        private static readonly ITopicPicture dal = DataAccess.CreateTopicPicture();

        #region TopicPicture Member
        ...
        {
            return dal.Delete(topicSubjectId);
        }
        ...
        {
            return dal.GetModel(topicSubjectId);
        }
