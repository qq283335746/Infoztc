...
{
    public partial class ActivitySubjectNew
    {
        private static readonly IActivitySubjectNew dal = DataAccess.CreateActivitySubjectNew();

        #region ActivitySubjectNew Member
