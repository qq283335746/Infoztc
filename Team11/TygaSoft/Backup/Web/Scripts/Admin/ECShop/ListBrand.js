...
var ListBrand = {
    ...
    Save: function () {
        ...
        $.ajax({
            url: ListBrand.Url,
            type: "post",
            data: '{model:{Id:"' + $("#hId").val() + '",BrandName:"' + $("#txtName").val() + '",BrandCode:"' + $("#txtCode").val() + '",ParentId:"' + $("#hParentId").val() + '",CategoryId:"' + categoryId + '",CategoryPictureId:"' + pictureId + '",Sort:' + sSort + ',Remark:"' + $("#txtRemark").val() + '"}}',
            contentType: "application/json; charset=utf-8",
            beforeSend: function () {
                $("#dlgWaiting").dialog('open');
            },
