...
namespace TygaSoft.SqlServerDAL
{
    public partial class Supplier : ISupplier
    {
        ...
        public int Insert(SupplierInfo model)
        {
            ...
            sb.Append(@"insert into Supplier (SupplierName,Phone,ProvinceCityName,Address,LastUpdatedDate)
			            values
        ...
        public int Update(SupplierInfo model)
        {
            ...
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Supplier set SupplierName = @SupplierName,Phone = @Phone,ProvinceCityName = @ProvinceCityName,Address = @Address,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
        ...
        public SupplierInfo GetModel(object Id)
        {
            ...
            sb.Append(@"select top 1 Id,SupplierName,Phone,ProvinceCityName,Address,LastUpdatedDate 
			            from Supplier
						where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
