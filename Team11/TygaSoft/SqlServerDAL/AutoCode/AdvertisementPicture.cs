...
{
    public partial class AdvertisementPicture : IAdvertisementPicture
    {
        #region IAdvertisementPicture Member

        public int Insert(AdvertisementPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"insert into AdvertisementPicture (FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(AdvertisementPictureInfo model)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update AdvertisementPicture set FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from AdvertisementPicture where Id = @Id");
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from AdvertisementPicture where Id = @Id" + n + " ;");
        ...
        public AdvertisementPictureInfo GetModel(object Id)
        {
            AdvertisementPictureInfo model = null;

            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from AdvertisementPicture
						where Id = @Id ");
            SqlParameter parm = new SqlParameter("@Id", SqlDbType.UniqueIdentifier);
            parm.Value = Guid.Parse(Id.ToString());
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, sb.ToString(), parm))
            {
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        model = new AdvertisementPictureInfo();
        ...
        public IList<AdvertisementPictureInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select count(*) from AdvertisementPicture ");
            ...
            if (totalRecords == 0) return new List<AdvertisementPictureInfo>();
            ...
            IList<AdvertisementPictureInfo> list = new List<AdvertisementPictureInfo>();
        ...
        public IList<AdvertisementPictureInfo> GetList(int pageIndex, int pageSize, string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        public IList<AdvertisementPictureInfo> GetList(string sqlWhere, params SqlParameter[] cmdParms)
        {
            StringBuilder sb = new StringBuilder(250);
        ...
        public IList<AdvertisementPictureInfo> GetList()
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"select Id,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,LastUpdatedDate 
			            from AdvertisementPicture
