...
<div class="easyui-panel" style="padding:10px;">
    ...
    <div class="row mt10">
        ...
        <div class="fl">
            <input id="cbbSiteFun" class="easyui-combobox" data-options="required:true,missingMessage:'必选项',valueField:'id',textField:'text',url: '../../Handlers/Admin/HandlerContentType.ashx?reqName=GetJsonForCombobox&enumCode=AdvertisementFun',method:'GET'" />
        </div>
        <div class="clr"></div>
    </div>
    <div class="row mt10">
        ...
        <div class="fl">
            <input id="cbbLayoutPosition" class="easyui-combobox" data-options="required:true,missingMessage:'必选项',valueField:'id',textField:'text',url: '../../Handlers/Admin/HandlerContentType.ashx?reqName=GetJsonForCombobox&enumCode=LayoutPosition',method:'GET'" />
        </div>
        <div class="clr"></div>
    </div>
    <div class="row mt10">
    ...
    <div class="row mt10">
        ...
        <div class="fl">
            <input type="text" id="txtSort" runat="server" clientidmode="Static" class="easyui-textbox" data-options="validType:'int'" />
        </div>
        <span class="clr"></span>
    </div>
    <div class="row mt10">
    ...
    <div class="row mt10">
        ...
        <div class="fl">
            <input type="text" id="txtVirtualViewCount" runat="server" clientidmode="Static" class="easyui-textbox" data-options="validType:'int'" />
        </div>
        <span class="clr"></span>
    </div>
    ...
    <div id="picBox" class="row mt10">
        ...
        <div class="fl mr10">
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="DlgPictureSelect.DlgMutil('AdvertisementPicture')">选 择</a>
        </div>
        <div class="fl" style="width:705px;">
            <div id="imgContentPicture">
                <div class="row_col w110 mb10" style="display:none; width:100%;">
...
<div id="dlgMutilSelectPicture" class="easyui-dialog" title="选择图片（多选）" data-options="closed:true,modal:true,href:'/t/tpicture.html?dlgId=dlgMutilSelectPicture&funName=AdvertisementPicture&isMutil=true',width:810,height:$(window).height()*0.8,
    buttons: [{
...
<script type="text/javascript" src="../../Scripts/Admin/AddAdvertisement.js"></script>
