...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
        ...
        <asp:Repeater ID="rpData" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><a href="javascript:void(0)" code='<%#string.Format("{0}{1}",Eval("FileDirectory"),Eval("FileName")) %>' onclick='ListPictureContent.ViewPic(this)'>查看原图</a> </td>
    ...
    <script type="text/javascript" src="../../Scripts/Admin/AboutSite/ListPictureContent.js"></script>
