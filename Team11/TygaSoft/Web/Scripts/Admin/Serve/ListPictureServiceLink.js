...
var ListPictureServiceLink = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureServiceLink";
        DlgPictureSelect.CallBack = "ListPictureServiceLink.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureServiceLink",
                        type: "post",
