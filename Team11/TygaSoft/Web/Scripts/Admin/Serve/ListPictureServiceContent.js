...
var ListPictureServiceContent = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureServiceContent";
        DlgPictureSelect.CallBack = "ListPictureServiceContent.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureServiceContent",
                        type: "post",
