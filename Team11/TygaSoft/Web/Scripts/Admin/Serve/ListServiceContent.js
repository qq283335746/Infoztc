...
var ListServiceContent = {
        ...
        try {
            ...
            $('#dlgFmServiceContent').form('submit', {
                ...
                onSubmit: function (param) {
                    ...
                    param.isDisable = $("#dlgFmServiceContent").find("input[name=rbtnList_ServiceContent]:checked").val();
    ...
    OnPictureClick: function () {
        DlgPictureSelect.DlgOpenId = "dlgSingleSelectServiceContentPicture";
        DlgPictureSelect.DlgSingle('PictureServiceContent');
    },
    SetSinglePicture: function (imgEleId) {
        var data = dlgSingleSelectServiceContentPicture.GetPicSelect();
        if (data.length > 0) {
