...
var ListPictureServiceItem = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureServiceItem";
        DlgPictureSelect.CallBack = "ListPictureServiceItem.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "../../ScriptServices/AdminService.asmx/DelPictureServiceItem",
                        type: "post",
